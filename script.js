    ...
    window.actualizarCarrito = function () {
        ...
        carrito.forEach((producto, index) => {
            ...
            li.innerHTML = `
                ...
                <span>${producto.nombre} - ${producto.peso} - Cantidad: ${producto.cantidad} - $${(producto.precio * producto.cantidad).toLocaleString("en-US")}</span>
        ...
        totalCarrito.textContent = `Total: $${total.toLocaleString("en-US")}`;
    ...
    function manejarCarrito() {
        ...
        function actualizarCarrito() {
            ...
            carrito.forEach((producto, index) => {
                ...
                li.innerHTML = `
                    <img src="${producto.imagen}" alt="${producto.nombre}" width="50">
                    <span>${producto.nombre} - ${producto.peso} - Cantidad: ${producto.cantidad} - $${(producto.precio * producto.cantidad).toLocaleString("en-US")}
                    <button class="eliminar" data-index="${index}">✖</button>
                `;
